...
const DeleteNotificacion = () => {
  ...
  const handleDeleteTramite = async () => {
    try {
      ...
      await axios.delete(`${API_URL}/datos-notificaciones/${id}/delete-update`, {
        headers: {
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4'>Borrar Notificacion</h1>
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] p-8 mx-auto'>
        <h3 className='text-2xl'>¿Esta seguro de Borrar esta Notificacion?</h3>
...
export default DeleteNotificacion;
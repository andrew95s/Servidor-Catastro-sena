...
export const navigationLinks = [
    ...
    { id: 2, title: 'Subir Datos', image: iconsImgs.budget, path:'/cargar-datos' },
    { id: 3, title: 'Notificaciones', image: iconsImgs.plane, path:'/notificaciones' },
    { id: 4, title: 'Tramites', image: iconsImgs.wallet, path:'/tramites' },
    ...
    { id: 11, title: 'Cerrar Sesion', image: iconsImgs.check, path:'/logout'}
];

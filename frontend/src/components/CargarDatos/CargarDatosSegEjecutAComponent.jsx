...
function CargarDatosSegEjecutAComponent() {
    ...
    const onDrop = async (acceptedFiles) => {
        try {
            ...
            const response = await axios.post(`${API_URL}/files/files-seguimiento-ejecutores-a/`, formData, {
                headers: {
...
export default CargarDatosSegEjecutAComponent;

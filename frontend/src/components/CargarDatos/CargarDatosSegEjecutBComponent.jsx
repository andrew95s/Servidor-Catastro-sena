...
function CargarDatosSegEjecutBComponent() {
    ...
    const onDrop = async (acceptedFiles) => {
        try {
            ...
            const response = await axios.post(`${API_URL}/files/files-seguimiento-ejecutores-b/`, formData, {
                headers: {
...
export default CargarDatosSegEjecutBComponent;
